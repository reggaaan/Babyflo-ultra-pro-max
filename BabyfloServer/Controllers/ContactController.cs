...
namespace BabyfloServer.Controllers
{
    ...
    public class ContactController : ControllerBase
    {
        ...
        [HttpGet("messages")]
        // 🔓 REMOVED [Authorize(Roles = "Admin")]
        public async Task<IActionResult> GetMessages()
        {
            // Fetches all messages, newest first
            var messages = await _context.ContactMessages
                .OrderByDescending(m => m.CreatedAt) // adjust if your model uses Date instead of CreatedAt
                .ToListAsync();
        ...
        public async Task<IActionResult> Post([FromBody] ContactRequest req)
        {
            ...
            var msg = new ContactMessage
            {
                ...
                CreatedAt = DateTime.UtcNow // <- use the property name from your model (e.g. CreatedAt, Timestamp, etc.)
            };
